...
description: Accented is a new accessibility testing tool that is meant to complement, not replace, existing solutions, and to make it even easier to catch a lot of accessibility issues as soon as they get introduced.
...
TODO: alternative (suggested by ChatGPT): Accented is a new frontend library that helps developers catch accessibility issues right in the browser — automatically, and in real time — with no browser extensions or manual audits.

TODO: explain who this is for (by ChatGPT):
Whether you’re just beginning to think about accessibility, already lint your JSX for issues, or write custom a11y test suites, Accented was designed to help you catch more issues sooner — and fix them while they’re still top-of-mind.
...
TODO: maybe add the screenshot here as the biggest aha moment.
...
TODO: maybe a table in addition to, or instead of, the above text?

| Tool type                          | Real-time? | Page context? | Setup effort | Framework-agnostic? |
| ---------------------------------- | ---------- | ------------- | ------------ | ------------------- |
| Linting (eslint-plugin-jsx-a11y)   | ✅          | ❌             | Low          | ❌ (JSX only)        |
| Browser DevTools (axe, Lighthouse) | ❌          | ✅             | Medium       | ✅                   |
| Tests (`@axe-core/playwright`)     | ❌          | ✅             | High         | ✅                   |
| **Accented**                       | ✅          | ✅             | **Low**      | ✅                   |


## What is Accented?

TODO: consider renaming. "How Accented Works" or "A Different Approach to Accessibility Auditing".
According to ChatGPT, "This frames the section as a novel approach rather than just a product intro."

TODO: Add something like "Just a few lines added to your dev environment — no browser extensions, no CLI, no config."
...
✅ Address “How noisy is it?” or “Will it break my app?”
These are common developer anxieties. You've already said it's dev-only and uses axe-core — great — but explicitly addressing those questions gives confidence.

Consider a brief reassurance section or callout like:

✅ Accented runs only in development mode
✅ It uses non-blocking overlays and doesn’t interfere with page behavior
✅ It has zero impact on production bundles
...
Happy accenting.
TODO: add a link to "Getting started".

TODO: also, find a place for something like this: "In fact, while building this site, Accented surfaced a contrast issue in code blocks."
