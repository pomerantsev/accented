...
description: The new CSS anchor positioning features help Accented align its UI elements more easily than it was possible with absolute or fixed positioning.
