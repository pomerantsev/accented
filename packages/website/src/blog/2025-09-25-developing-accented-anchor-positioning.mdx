...
import stickyVideo from '~/assets/videos/sticky.mov';
import scrollableRegionVideo from '~/assets/videos/scrollable-region.mov';
import anchoredVideo from '~/assets/videos/anchored.mov';
...
<video src={stickyVideo} width="386" height="304" controls></video>
...
<video src={scrollableRegionVideo} width="386" height="304" controls></video>
...
TODO: this likely needs to be rephrased, the flow of thoughts is a bit broken.
...
<video src={anchoredVideo} width="386" height="304" controls></video>
...
accented-trigger {
  ...
  /* Used to be: right: anchor(right); */
  inset-inline-end: anchor(end);

  /* Used to be: top: anchor(top); */
...
But using CSS logical properties and values is a step towards making it look
