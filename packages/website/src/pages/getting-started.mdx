...
import stylingExample from './images/styling-example.png';
...
<div class="image-frame">
  <Image
    src={stylingExample}
    alt="
      Two screenshots of the same web application side by side, both with the same highlights by Accented.
      On the left, the highlights have the regular styles.
      On the right, the highlights are dark green instead of violet red, and the outlines are dashed instead of solid.
    "
    layout="full-width"
  />
</div>
