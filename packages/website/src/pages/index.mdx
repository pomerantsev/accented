...
- **Outputs issue notifications both as highlights on the page and as console messages.**
  If you prefer Accented not to modify the DOM at all, you can enable a [console-only mode](/getting-started#console-only-mode).
