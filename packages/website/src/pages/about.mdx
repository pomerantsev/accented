...
- A behavioral change that isn’t a bug fix and doesn’t break the Accented API
  (for example, when Accented starts reporting a new class of issues).
  This applies whether the change originates in Accented itself or in a runtime dependency bump.
